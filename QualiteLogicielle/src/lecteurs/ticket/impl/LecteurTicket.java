...
public class LecteurTicket implements ILecteurTicket {
  ...
  public boolean restitutionTicket(final boolean retour) {
    if (retour) {
      ...
      LOG.warning("Un message s'affiche : \"Ticket erroné\""
           + " sur l'écran du lecteur de ticket et le ticket sort");
    }
    return retour;
  }
   ...
   * 
   */
  public boolean verificationTicket(final ISystemeInformatique sys, 
