...
public interface ILecteurBancaire {
   ...
   * 
   */
  boolean realiseTransaction(ISystemeInformatique sys, ILecteurTicket lecteurTicket,
      final IBarriereSortie barriere) throws TicketErreur, BarriereErreur, CarteBancaireErreur;
}
