...
public interface ISystemeInformatique {
   ...
   */
  boolean checkTicket(final IAbstractTicket ticket, 
       final ILecteurTicket lecteur, final ILecteurBancaire lecteurBancaire) throws TicketErreur;
   ...
   * 
   */
  boolean checkAbonnement(final IAbstractCarte carte, final ILecteurCarteAbonnement lecteur,
      IBarriereSortie barriere) throws CarteAbonnementErreur, BarriereErreur;
}
