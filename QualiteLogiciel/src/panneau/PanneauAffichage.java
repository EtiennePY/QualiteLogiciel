...
public class PanneauAffichage {
	...
	public void add(){
		...
		System.out.println("Le panneau d'affichage incrémente le nombre de vehicules entrés");
	}
	
	public void minus(){
		this.setSortis(this.sortis+1);
		System.out.println("Le panneau d'affichage incrémente le nombre de vehicules sortis");
	}
}
